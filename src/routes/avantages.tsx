...
> = {
  fr: {
    ...
    categories: [
      ...
      { title: "Sacs & chaussures", description: "Sacs à main, sacs à dos, baskets, ceintures" },
    ],
  ...
  en: {
    ...
    categories: [
      ...
      { title: "Bags & shoes", description: "Handbags, backpacks, sneakers, belts" },
    ],
  ...
  ar: {
    ...
    categories: [
      ...
      { title: "الحقائب والأحذية", description: "حقائب اليد، حقائب الظهر، السنيكرز، الأحزمة" },
    ],
