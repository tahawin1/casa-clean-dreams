...
const CATEGORIES: PriceCategory[] = [
  {
    ...
    items: [
      { name: "Pantalon", wash: "25 DH", iron: "13 DH" },
      { name: "Chemise sur cintre", wash: "22 DH", iron: "10 DH" },
      { name: "Chemise pliée", wash: "23 DH", iron: "12 DH" },
      { name: "Costume / Tailleur femme", wash: "45 DH", iron: "25 DH" },
      { name: "Veste", wash: "30 DH", iron: "15 DH" },
      { name: "Pull", wash: "23 DH", iron: "15 DH" },
      { name: "Robe", wash: "38 DH", iron: "20 DH" },
      { name: "Jupe", wash: "25 DH", iron: "15 DH" },
      { name: "Manteau · à partir de", wash: "50 DH", iron: "20 DH" },
      { name: "Doudoune", wash: "50 DH", iron: "—" },
      { name: "Doudoune plume", wash: "60 DH", iron: "—" },
      { name: "Blouson", wash: "40 DH", iron: "18 DH" },
      { name: "Polo", wash: "20 DH", iron: "8 DH" },
      { name: "T-shirt", wash: "15 DH", iron: "8 DH" },
  ...
  },
  {
    ...
    description:
      "Takchita, caftan, djellaba et jabador traités avec un soin particulier pour préserver tissus et broderies.",
    icon: <Sparkles className="h-5 w-5" />,
    items: [
      { name: "Tenue traditionnelle « Takchita » · à partir de", wash: "150 DH", iron: "60 DH" },
      { name: "Djellaba · à partir de", wash: "40 DH", iron: "18 DH" },
      { name: "Caftan · à partir de", wash: "70 DH", iron: "30 DH" },
      { name: "Jabador · à partir de", wash: "45 DH", iron: "28 DH" },
    ],
  },
  {
