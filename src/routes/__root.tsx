...
const GA_MEASUREMENT_ID = "G-GJMDC6DLZW";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pressing Zerktouni à Casablanca, 237 Bd Mohamed Zerktouni. Depuis 2010, nettoyage à sec, blanchisserie, repassage, sacs et tapis. Service express 6h, ramassage et livraison gratuite." },
      { name: "author", content: "Pressing Zerktouni" },
      { property: "og:title", content: "Pressing Zerktouni Casablanca | Nettoyage à Sec 24h" },
      { property: "og:description", content: "Votre pressing Zerktouni à Casablanca. Nettoyage à sec, repassage, blanchisserie, tapis et entretien des sacs. Express 6h et livraison gratuite." },
